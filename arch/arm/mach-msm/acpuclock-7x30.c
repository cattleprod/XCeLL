...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
        ...
        { 184320, PLL_3,    5, 4,  61440,  850, VDD_RAW(850) },
        { MAX_AXI_KHZ, SRC_AXI, 1, 0, 61440, 850, VDD_RAW(850) },
        { 153600, PLL_3,    5, 2,  30720,  850, VDD_RAW(850) },
        { 307200, PLL_3,    5, 1,  192000, 900, VDD_RAW(900) },
        { 491200, PLL_1,    2, 0,  192000, 950, VDD_RAW(950) },
        /* Make sure any freq based from PLL_2 is a multiple of 19200! */
        { 683200, PLL_2,    3, 0,  192000, 975, VDD_RAW(975) },
        { 875200, PLL_2,    3, 0,  192000, 1000, VDD_RAW(1000) },
        { 1067200, PLL_2,    3, 0,  192000, 1050, VDD_RAW(1050) },
        { 1259200, PLL_2,    3, 0,  192000, 1100, VDD_RAW(1100) },
        { 1451200, PLL_2,    3, 0,  192000, 1250, VDD_RAW(1250) },
        { 1643200, PLL_2,    3, 0,  192000, 1350, VDD_RAW(1350) },
        { 1835200, PLL_2,    3, 0,  192000, 1450, VDD_RAW(1450) },
		{ 0 }
};
...
static unsigned int acpuclk_get_current_vdd(void)
{
	...
	for (vdd_mv = 750; vdd_mv <= 1450; vdd_mv += 25)
